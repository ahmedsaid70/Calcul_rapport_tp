...
/* ** argv: Values of arguments */
{
  ...
  write_vec(RHS, &la, "DATA/ITERATIVE/RHS/RHS.dat");
  write_vec(EX_SOL, &la, "DATA/ITERATIVE/SOL/EX_SOL.dat");
  write_vec(X, &la, "DATA/ITERATIVE/X_grid.dat");
  ...
  write_GB_operator_colMajor_poisson1D(AB, &lab, &la, "DATA/ITERATIVE/AB/AB.dat");
  ...
  /* Write solution */
  write_vec(SOL, &la, "DATA/ITERATIVE/SOL/SOL.dat");

  /* Write convergence history */
  write_vec(resvec, &nbite, "DATA/ITERATIVE/RESVEC.dat");
